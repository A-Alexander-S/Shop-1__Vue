Vue.component('cart', {
    ...
    <a @click="showCart = !showCart" href="#" class="header__button header__basket btn-cart">
            ...
            <path
                ...
                <div v-show="showCart" class="cart-block"> 
                    <ul class="cart-block__list">
                        <cart-item v-for="item of cartItems" :cartItem="item" @remove="remove" :key="item.id">
                        </cart-item>
                    </ul>
                </div>
                </li>`
...
Vue.component('cart-item', {
    ...
    template: `<li class="cart-block__list-item">
                    ...
                    <div class="cart-block__right-block">
                        ...
                        <button @click="$emit('remove', cartItem)" class="cart-block__del-btn">
